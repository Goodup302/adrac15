<?php do_action( 'futurio_before_menu' ); ?>
    <div class="main-menu">
        <nav id="site-navigation" class="navbar navbar-default nav-pos-<?php echo esc_html( get_theme_mod( 'main_menu_float', 'right' ) ); ?>">
            <div class="<?php echo esc_html( get_theme_mod( 'main_menu_content_width', 'container' ) ) ?>">
                ...
                wp_nav_menu( array(
                    ...
                    'menu_class'		 => 'nav navbar-nav navbar-' . esc_html( get_theme_mod( 'main_menu_float', 'right' ) ),
